...
%%%%%%%%%% header & footer data
\def\hemail{\ifx\docemail\empty \else\begin{adjustbox}{max width=0.33\textwidth}\linkemail\end{adjustbox} \fi }
...
%%%%%%%%%% first page header (use \thispagestyle{first} after \begin{document})
...
\fancyhead[C]{\begin{tabular}{c}
 \ifboolexpr{test{\ifdefempty{\docphone}}}{}{\hemail}\\\doccitystate % Readded \hemail
 \end{tabular}} %
\fancyhead[R]{\begin{tabular}{r}
 \ifboolexpr{test{\ifdefempty{\docphone}}}{\hemail}{\hphone}\\\doczip % Readded \hphone
 \end{tabular}} %
}
...
%%%%%%%%%% header & footer data
\def\hemail{\ifx\docemail\empty \else\linkemail \fi }
...
\fancyfoot[R]{\scriptsize\docdate\\\fversionfile}%
\renewcommand{\headrulewidth}{0.5pt}
\renewcommand{\footrulewidth}{0.5pt}
...
%%%%%%%%%%%%%%% docmassbaymemorandum OR docmassbaypaper %%%%%%%%%%%%%%
\ifboolexpr{test{\ifdef{\docmassbaymemorandum}} or test{\ifdef{\docmassbaypaper}}}{ % massbay memorandum / paper template: include \def\docmassbaymemorandum{} OR \def\docmassbaypaper{} in document
...
}{}%\ifboolexpr{test{\ifdef{\docmassbaymemorandum}} or test{\ifdef{\docmassbaypaper}}}
