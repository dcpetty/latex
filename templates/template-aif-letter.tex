...
\def\docbhsletter{} % NOT YET SPECIAL AIF LETTER STYLE
\def\docname{Ansell}%
\def\docdate{2021/07/16}%
\def\doctitle{Education Program Manager}%
\def\docemail{dcp@appinventor.org}%
...
\begin{tabularx}{\textwidth}{@{}lXr@{}}\\[0.25cm]
 \large\bf\textit{Natalie Lao, PhD} && \large\bf\textit{} \\
...
%\vspace{2cm}
% \includegraphics*[height=2cm]{../images/sig-dcp.png}  \\ % dcp signature
 \docfrom \\
 \doctitle\vspace{3ex}
